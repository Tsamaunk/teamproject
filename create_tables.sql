...
INSERT INTO `users` (`firstName`, `lastName`, `password`, `email`, `role`, `created`, `approvedBy`) VALUES ('Default', 'Admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@admin.admin', 2, 1234567890, 1); #default admin with password admin
